...
export function BrandContent({
  ...
  const pageGraph = {
    ...
    '@id': `https://isun1.com${url(path)}#webpage`,
    url: `https://isun1.com${url(path)}`,
          ...
          <div className="columns">
            <div>
              ...
              <a
                ...
                href="mailto:admin@tideisun.com"
              >
                admin@tideisun.com
        ...
        <section className="page-content">
          ...
          <div className="notice">
            {!registry.published && (
              <p>
                {t(
                  '公開登記正在準備中。現階段，請向 admin@tideisun.com 核實授權。未查到紀錄不等於判定為冒用；請先聯絡我們。',
                  'The public register is being prepared. For now, confirm authorizations with admin@tideisun.com. An absent record is not, by itself, a finding of misuse.',
                )}
              </p>
            )}
            <p>
