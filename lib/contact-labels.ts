...
const source = {
  "Loading the form. You can also email admin@tideisun.com.": "正在載入表單，亦可直接寄信至 admin@tideisun.com。",
  ...
  "Business email": "聯絡電郵",
  "Privacy notice": "私隱說明",
  "Delivery could not be confirmed. Please email admin@tideisun.com directly.": "目前無法確認寄送結果。請直接寄信至 admin@tideisun.com。",
  "Interviews": "採訪合作",
  "Organization": "機構名稱",
  "Sending…": "傳送中…",
  "For enquiries, please email admin@tideisun.com directly. Online submission is not yet available.": "請直接寄信至 admin@tideisun.com 洽談合作。網上提交尚未開放。",
  "Other enquiry": "其他查詢",
