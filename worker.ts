...
const publicPage = /^\/(?:zh-Hant\/|en\/|fr\/|es\/|ja\/|hi\/|he\/)?(?:about|global|interviews|chairman|robin|licensing|privacy)?$/;
const localeHome = /^\/(?:zh-Hant|en|fr|es|ja|hi|he)$/;
export function canCache(request: Request) {
  ...
  return url.hostname === 'isun1.com' && request.method === 'GET' && !url.search &&
